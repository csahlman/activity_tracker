...
(function() {
  ...
  angular.module('venture').config(function($httpProvider) {
  ...
  angular.module('venture').config(function($routeProvider) {
...
angular.module('venture').config(["$httpProvider", function(provider) {
...
(function() {
  angular.module('venture').controller('AppCtrl', function($scope) {});

}).call(this);
(function() {
  angular.module('venture').controller('CostsCtrl', function($http, $scope, $location) {
    $scope.developers = [
      {
        name: "John Foo",
        salary: 82000
...
(function() {
  angular.module('venture').controller('FormsCtrl', function($scope, $http, $location) {
    $scope.formData = {
    ...
    $scope.setFrame = function(frame) {
      return $scope.sideFrame = frame;
    };
    $scope.setTab = function(value) {
      return $scope.tab = value;
    };
    $scope.calculateTotalCost = function(months) {
      return $scope.calculateFixedCost() + $scope.calculateDeveloperCost();
    };
    $scope.calculateFixedCost = function(months) {
      var sum;
      ...
      return sum += $scope.localCosts.domainNameCost * $scope.formData.domain_name_quantity;
    };
    $scope.calculateDeveloperCost = function(months) {
      var sum;
      sum = $scope.localCosts.developerCost * $scope.formData.developer_quantity;
      return sum += $scope.localCosts.designerCost * $scope.formData.designer_quantity;
    };
    ...
    return $scope.loadFormData();
  });

}).call(this);
(function() {
  angular.module('venture').controller('InformationCtrl', function($scope, $http, $location) {
    return $scope.llcAttorneys = [
      {
        name: "Saul",
        location: "Denver",
        cost: 2500,
        phoneNumber: '617-555-4949'
      }, {
        name: "Walt",
        location: "Broomfield",
        cost: 2360,
        phoneNumber: '303-555-2949'
      }, {
        name: "Frank",
        location: "Boulder",
        cost: 3000,
        phoneNumber: '202-145-2000'
      }
    ];
  });
...
(function() {
  angular.module('venture').controller('StartCtrl', function($scope, $http, $location) {
    return $scope["continue"] = function() {
      $scope.saveState();
      return $location.path('/costs');
    };
  });
